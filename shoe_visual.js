...
(function(){
  function enhance(){
    ...
    const curve=new THREE.CatmullRomCurve3([
      new THREE.Vector3(.45,.46,0),
      new THREE.Vector3(1.35,.38,0),
      new THREE.Vector3(2.35,.40,0),
      new THREE.Vector3(3.25,.58,0),
      new THREE.Vector3(4.05,.98,0),
      new THREE.Vector3(4.55,1.60,0),
      new THREE.Vector3(4.58,2.28,0),
      new THREE.Vector3(4.28,2.82,0),
      new THREE.Vector3(3.72,3.05,0)
    ]);
    ...
    const goldCurve=new THREE.CatmullRomCurve3([
      new THREE.Vector3(.55,.78,.02),
      new THREE.Vector3(1.45,.70,.02),
      new THREE.Vector3(2.35,.72,.02),
      new THREE.Vector3(3.25,.90,.02),
      new THREE.Vector3(4.03,1.30,.02),
      new THREE.Vector3(4.48,1.90,.02),
      new THREE.Vector3(4.50,2.50,.02),
      new THREE.Vector3(4.22,2.88,.02)
    ]);
    const trim=new THREE.Mesh(new THREE.TubeGeometry(goldCurve,64,.065,9,false),edge); shoe.add(trim);

    // Strong luminous jewel at the very end of the curl.
    ...
    // Decorative hanging tassel under the hook.
